...
<div class="app-root">
	...
	{:else}
		...
		<nav class="bottom-tabs">
			<a href="/nominate" class:selected={$page.url.pathname === '/nominate'}>
			...
			<a href="/leaderboard" class:selected={$page.url.pathname === '/leaderboard'}>
				<span class="icon">🏆</span>
				<span>Top</span>
			</a>
		...
		{#if showProfileMenu}
			...
			<div class="profile-menu card" transition:scale={{ duration: 150, start: 0.9 }}>
